...
static const char const *DAC_DL_SIDEGEN_SAMEPLRATE[] = {"8K", "11K", "12K", "16K", "22K", "24K", "32K", "44K", "48K"};

static int mDac_Sidegen_Amplitude = 6;
static const char const *DAC_DL_SIDEGEN_AMPLITUE[] = {"1/128", "1/64", "1/32", "1/16", "1/8", "1/4", "1/2", "1"};
...
static const char const *ANDROID_AUDIO_MODE[] = {
	"Normal_Mode", "Ringtone_Mode", "Incall_Mode", "Communication_Mode", "Incall2_Mode", "Incall_External_Mode"};
