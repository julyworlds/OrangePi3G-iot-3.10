...
***************************************************************/
static int mt_hotplug_mechanism_read_test0(struct file *filep, char __user *buf, size_t count, loff_t *offp)
{
    char *p = buf;
...
static int mt_hotplug_mechanism_write_test0 (struct file *filep, const char __user *buffer, size_t count, loff_t *offp)
{
    int len = 0, test0 = 0;
    char desc[32];
...
***************************************************************/
static int mt_hotplug_mechanism_read_test1 (struct file *filep, char __user *buf, size_t count, loff_t *offp) 
{
    char *p = buf;
...
static int mt_hotplug_mechanism_write_test1  (struct file *filep, const char __user *buffer, size_t count, loff_t *offp)
{
    int len = 0, test1 = 0;
    char desc[32];
...
static const struct file_operations test0_ops = {
        .read = mt_hotplug_mechanism_read_test0,
        .write = mt_hotplug_mechanism_write_test0,
};

static const struct file_operations test1_ops = {
        .read = mt_hotplug_mechanism_read_test1,
...
static int __init mt_hotplug_mechanism_init(void)
{
    ...
    {
            entry = proc_create("test0", S_IRUGO | S_IWUSR, mt_hotplug_test_dir, &test0_ops);
            entry = proc_create("test1", S_IRUGO | S_IWUSR, mt_hotplug_test_dir, &test1_ops);
    }
