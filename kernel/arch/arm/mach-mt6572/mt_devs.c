...
extern struct tag_pt_info otp_info;
extern struct tag_pt_info bmt_info;
...
flashdev_info_t gen_FlashTable_p[10];
#endif
...
u64 bl_mem_sz = 0x0;       // bl_mem_sz is inited in mt_fixup
...
void mt_fixup(struct tag *tags, char **cmdline, struct meminfo *mi)
{
    ...
    MTK_MEMCFG_LOG_AND_PRINTK(KERN_ALERT
            ...
            "[PHY layout]mtk_wcn_consys_memory_reserve :   0x%llx - 0x%llx  (0x%llx)\n",
...
/* Charger IC driver                                                         */
/*=======================================================================*/
#if defined (CONFIG_MTK_SNB1058_SUPPORT)
...
"   WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING WARNING\n"
"******************************************************************************\n"
"\n",   bl_fb.base, bl_fb.size, (long unsigned int)FB_START, FB_SIZE);*/
