...
do {                                                                                  \
		...
		static const struct file_operations fh_proc_fops = {		                          \
			.owner = THIS_MODULE,		                                                        \
			.read = freqhop_proc_##fILENAME##_read,		                                      \
			.write = freqhop_proc_##fILENAME##_write,		                                    \
		};		                                                                            \
		pEntry = proc_create(#fILENAME,  S_IRUGO | S_IWUSR | S_IWGRP, proc_dir, &fh_proc_fops); 		\
		if(pEntry)                                                                        \
		{                                                                                 \
