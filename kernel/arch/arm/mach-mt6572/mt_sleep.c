...
#define SLP_LOG_TAG     "Power/Sleep "
#if SLP_SUSPEND_LOG_EN
#define slp_xverb(fmt, args...)		pr_info(SLP_LOG_TAG fmt, ##args)
#else
#define slp_xverb(fmt, args...)		pr_debug(SLP_LOG_TAG fmt, ##args)
#endif

#define slp_xinfo(fmt, args...)		pr_info(SLP_LOG_TAG fmt, ##args)

#define slp_xerror(fmt, args...)	pr_err(SLP_LOG_TAG fmt, ##args)
