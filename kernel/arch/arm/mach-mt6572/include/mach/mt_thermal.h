#ifndef _MT6572_THERMAL_H
#define _MT6572_THERMAL_H
...
#define AUXADC_CON0_P       (IO_VIRT_TO_PHYS(AUXADC_BASE) + 0x000)
#define AUXADC_CON1_P       (IO_VIRT_TO_PHYS(AUXADC_BASE) + 0x004)
#define AUXADC_CON1_SET_P   (IO_VIRT_TO_PHYS(AUXADC_BASE) + 0x008)
#define AUXADC_CON1_CLR_P   (IO_VIRT_TO_PHYS(AUXADC_BASE) + 0x00C)
#define AUXADC_DAT11_P      (IO_VIRT_TO_PHYS(AUXADC_BASE) + 0x040)
 ...
 ******************************************************************************/
 ...
 #define TS_CON0_P           (IO_VIRT_TO_PHYS(APMIXED_BASE) + 0x600)
 ...
 ******************************************************************************/
#define TEMPMONCTL0         (THERMAL_BASE + 0x000) //yes 0x1100d000
...
//#define THERMAL_WRAP_SET_BIT(BS,REG)       mt65xx_reg_sync_writel((__raw_readl((void *)REG) | (U32)(BS)), ((void *)REG))
//#define THERMAL_WRAP_CLR_BIT(BS,REG)       mt65xx_reg_sync_writel((__raw_readl((void *)REG) & (~(U32)(BS))), ((void *)REG))
