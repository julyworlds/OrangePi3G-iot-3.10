...
********************************************************************************
*/
unsigned int gDbgLevelCK = BT_LOG_DBG;
...
#define CUSTOM_BT_CFG_FILE          "/etc/BT_Addr"
...
{
    // struct hci_stp *hu = (struct hci_stp *)hdev->driver_data;//CKT sunqidong modify for krillin kernel
