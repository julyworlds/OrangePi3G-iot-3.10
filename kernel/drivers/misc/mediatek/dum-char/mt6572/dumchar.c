...
static int __init dumchar_init(void)
{
	int result;
	printk("dumchar_int\n");
	dumchar_devices = kzalloc(PART_MAX_COUNT*sizeof (struct dumchar_dev), GFP_KERNEL);
	if (!dumchar_devices) {
		result = -ENOMEM;
