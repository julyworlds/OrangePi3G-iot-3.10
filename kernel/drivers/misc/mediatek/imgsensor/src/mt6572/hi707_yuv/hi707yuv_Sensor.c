...
#define SENSORDB(x,...)
#endif
#define HI707_TEST_PATTERN_CHECKSUM (0x7ba87eae)
...
static void HI707_Initial_Setting(void)
{
	...
	HI707_Set_VGA_mode();
		...
		//	HI707_write_cmos_sensor(0x43, 0x68);//,
			...
			/////////////////////////////////////////////////////////////////////14page LSC 20120214 ??\A1\A7\A1\E9?\A8\A8//////////
			...
			HI707_write_cmos_sensor(0x88, 0x02);// //EXP Max(120Hz) 10.00 fps 
			HI707_write_cmos_sensor(0x89, 0x49);// 
			HI707_write_cmos_sensor(0x8a, 0xf0);// 
	
			HI707_write_cmos_sensor(0xa0, 0x02);// //EXP Max(100Hz) 10.00 fps 
			HI707_write_cmos_sensor(0xa1, 0x49);// 
			HI707_write_cmos_sensor(0xa2, 0xf0);// 
	...
	//	0x43, 0x68,////,
		...
		/////////////////////////////////////////////////////////////////////14page LSC 20120214 ???\A1\EC?\A8\A6?\A1\A7\A1\A7//////////
		0x03, 0x14,////,
		0x10, 0x01,////,
...
BOOL HI707_set_param_exposure(UINT16 para)
{
    ...
    spin_unlock(&hi707_yuv_drv_lock);
	if ( ((UINT16)SCENE_MODE_HDR == (HI707_sensor.SceneMode)) && ((UINT16)SENSOR_MODE_CAPTURE == (HI707_sensor.Sensor_mode)))
	{			  
			   switch (para)
					{
					  case AE_EV_COMP_n10:	
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_SET_REGISTER:
        HI707_write_cmos_sensor(pSensorRegData->RegAddr, pSensorRegData->RegData);
        break;
    case SENSOR_FEATURE_GET_REGISTER:
        pSensorRegData->RegData = HI707_read_cmos_sensor(pSensorRegData->RegAddr);
        break;
	...
	case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
		HI707GetAEAWBLock((UINT32 *)(*pFeatureData32),(UINT32 *)(*(pFeatureData32+1)));
		break;
