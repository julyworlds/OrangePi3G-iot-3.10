...
#if !defined(CONFIG_MTK_NATIVE_3D_SUPPORT) //2D
  #define S5K4ECGX_MIPIYUV_MAIN_2_USE_HW_I2C
#else //CONFIG_MTK_NATIVE_3D_SUPPORT
  #define S5K4ECGX_MIPIYUV_MAIN_2_USE_HW_I2C
...
#define S5K4ECGX_TEST_PATTERN_CHECKSUM (0x25e83d55)
...
S5K4ECGX_MIPI_AE_Set_Window(
    ...
    unsigned int prevH)
{
if (s5k4ec_cap_enable){
	SENSORDB("[4EC] during capture, dont update AE for preview\n");
...
static void S5K4ECGX_MIPI_GetCurAeAwbInfo(UINT32 Info)
{
    ...
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    {
        //Reset AE table due to Preview Size Changed
        S5K4ECGX_MIPI_AE_Set_Window((unsigned int)S5K4ECGX_Driver.apAEWindows,
               ...
               UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_EV_AWB_REF:
             ...
             S5K4ECGX_MIPI_GetEvAwbRef((PSENSOR_AE_AWB_REF_STRUCT) (*pFeatureData32));
             break;
        ...
        case SENSOR_FEATURE_GET_EXIF_INFO:
             ...
             S5K4ECGX_MIPI_GetExifInfo((UINT32) (*pFeatureData32));
             break;
  #endif

        case SENSOR_FEATURE_GET_DELAY_INFO:
             SENSORDB("[4EC] F_GET_DELAY_INFO\n");
             S5K4ECGX_MIPI_GetDelayInfo((UINT32) (*pFeatureData32));
             break;
        ...
        case SENSOR_FEATURE_MOVE_FOCUS_LENS:
             ...
             S5K4ECGX_MIPI_AF_Move_to((unsigned int)pFeatureReturnPara32); // not implement yet.
             break;
        ...
        case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
             ...
             S5K4ECGX_MIPI_get_AEAWB_lock((UINT32 *)(*pFeatureData32),(UINT32 *)(*(pFeatureData32+1)));
             break;
