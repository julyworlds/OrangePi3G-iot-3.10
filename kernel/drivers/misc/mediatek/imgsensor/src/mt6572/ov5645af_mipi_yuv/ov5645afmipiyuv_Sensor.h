...
typedef enum {
    ...
    SENSOR_MODE_PREVIEW,
    SENSOR_MODE_CAPTURE
} OV5645AFMIPI_SENSOR_MODE;

typedef enum _OV5645AFMIPI_OP_TYPE_ {
        OV5645AFMIPI_MODE_NONE,
        OV5645AFMIPI_MODE_PREVIEW,
        OV5645AFMIPI_MODE_CAPTURE,
        OV5645AFMIPI_MODE_QCIF_VIDEO,
        OV5645AFMIPI_MODE_CIF_VIDEO,
        OV5645AFMIPI_MODE_QVGA_VIDEO
    } OV5645AFMIPI_OP_TYPE;

extern OV5645AFMIPI_OP_TYPE OV5645AFMIPI_g_iOV5645AFMIPI_Mode;

#define OV5645AFMIPI_ID_REG                          (0x300A)
#define OV5645AFMIPI_INFO_REG                        (0x300B)
 
/* sensor size */
#define OV5645AFMIPI_IMAGE_SENSOR_SVGA_WIDTH          (1280)
#define OV5645AFMIPI_IMAGE_SENSOR_SVGA_HEIGHT         (960)
#define OV5645AFMIPI_IMAGE_SENSOR_QSXGA_WITDH         (2590)//(2592)
#define OV5645AFMIPI_IMAGE_SENSOR_QSXGA_HEIGHT        (1942)//(1944)
#define OV5645AFMIPI_IMAGE_SENSOR_VIDEO_WITDH         (1280) 
#define OV5645AFMIPI_IMAGE_SENSOR_VIDEO_HEIGHT        (960)

#define OV5645AFMIPI_IMAGE_SENSOR_720P_WIDTH          (1280)
#define OV5645AFMIPI_IMAGE_SENSOR_720P_HEIGHT         (720)


/* Sesnor Pixel/Line Numbers in One Period */	
#define OV5645AFMIPI_PV_PERIOD_PIXEL_NUMS    		(1896)  	/* Default preview line length HTS*/
#define OV5645AFMIPI_PV_PERIOD_LINE_NUMS     		(984)   	/* Default preview frame length  VTS*/
#define OV5645AFMIPI_FULL_PERIOD_PIXEL_NUMS  		(2844)  	/* Default full size line length */
#define OV5645AFMIPI_FULL_PERIOD_LINE_NUMS   		(1968)  	/* Default full size frame length */

/* Sensor Exposure Line Limitation */
#define OV5645AFMIPI_PV_EXPOSURE_LIMITATION      	(984-4)
#define OV5645AFMIPI_FULL_EXPOSURE_LIMITATION    	(1968-4)

/* Config the ISP grab start x & start y, Config the ISP grab width & height */
#define OV5645AFMIPI_PV_GRAB_START_X 				   (0)
#define OV5645AFMIPI_PV_GRAB_START_Y  			(1)
#define OV5645AFMIPI_FULL_GRAB_START_X   			(0)
#define OV5645AFMIPI_FULL_GRAB_START_Y	  		(1)

/*50Hz,60Hz*/
#define OV5645AFMIPI_NUM_50HZ                        (50 * 2)
#define OV5645AFMIPI_NUM_60HZ                        (60 * 2)

/* FRAME RATE UNIT */
#define OV5645AFMIPI_FRAME_RATE_UNIT                 (10)

/* MAX CAMERA FRAME RATE */
#define OV5645AFMIPI_MAX_CAMERA_FPS                  (OV5645AFMIPI_FRAME_RATE_UNIT * 30)

#define OV5645AF_PREVIEW_MODE             0
#define OV5645AF_VIDEO_MODE               1
#define OV5645AF_PREVIEW_FULLSIZE_MODE    2


/* SENSOR READ/WRITE ID */
#define OV5645AFMIPI_WRITE_ID						    0x78
#define OV5645AFMIPI_READ_ID							0x79
...
UINT32 OV5645AFMIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT pfFunc);

static const kal_uint8 OV5645AF_addr_data_pair1[254] =
{
...
static const kal_uint8 OV5645AF_addr_data_pair2[255] =
{
	//0x80fc
	0x80,
	0xfc,
...
static const kal_uint8 OV5645AF_addr_data_pair3[255] =
{
	//0x81f9
	0x81,
	0xf9,
...
static const kal_uint8 OV5645AF_addr_data_pair4[255] =
{
	//0x82f6
	0x82,
	0xf6,
...
static const kal_uint8 OV5645AF_addr_data_pair5[255] =
{
	//0x83f3
	0x83,
	0xf3,
...
static const kal_uint8 OV5645AF_addr_data_pair6[255] =
{
	//0x84f0
	0x84,
	0xf0,
...
static const kal_uint8 OV5645AF_addr_data_pair7[255] =
{
	//0x85ed
	0x85,
	0xed,
...
static const kal_uint8 OV5645AF_addr_data_pair8[255] =
{
	//0x86ea
	0x86,
	0xea,
...
static const kal_uint8 OV5645AF_addr_data_pair9[255] =
{
	//0x87e7
	0x87,
	0xe7,
...
static const kal_uint8 OV5645AF_addr_data_pair10[255] =
{
	//0x88e4,
	0x88,
	0xe4,
...
static const kal_uint8 OV5645AF_addr_data_pair11[255] =
{
	//0x89e1
	0x89,
	0xe1,
...
static const kal_uint8 OV5645AF_addr_data_pair12[255] =
{
	//0x8ade
	0x8a,
	0xde,
...
static const kal_uint8 OV5645AF_addr_data_pair13[255] =
{
	//0x8bdb
	0x8b,
	0xdb,
...
static const kal_uint8 OV5645AF_addr_data_pair14[255] =
{
	//0x8cd8
	0x8c,
	0xd8,
...
static const kal_uint8 OV5645AF_addr_data_pair15[255] =
{
	//0x8dd5,
	0x8d,
	0xd5,
...
static const kal_uint8 OV5645AF_addr_data_pair16[255] =
{
	//0x8ed2
	0x8e,
	0xd2,
...
static const kal_uint8 OV5645AF_addr_data_pair17[255] =
{
	//0x8fcf,
	0x8f,
	0xcf,
...
static const kal_uint8 OV5645AF_addr_data_pair18[255] =
{
	//0x90cc,
	0x90,
	0xcc,
...
static const kal_uint8 OV5645AF_addr_data_pair19[255] =
{
	//0x91c9
	0x91,
	0xc9,
...
static const kal_uint8 OV5645AF_addr_data_pair20[255] =
{
	//0x92c6,
	0x92,
	0xc6,
...
static const kal_uint8 OV5645AF_addr_data_pair21[255] =
{
	//0x93c3
	0x93,
	0xc3,
...
static const kal_uint8 OV5645AF_addr_data_pair22[181] =
{
	//0x94c0,
	0x94,
	0xc0,
