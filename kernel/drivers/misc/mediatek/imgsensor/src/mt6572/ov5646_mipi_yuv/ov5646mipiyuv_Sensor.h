...
typedef enum {
    ...
    SENSOR_MODE_PREVIEW,
    SENSOR_MODE_CAPTURE
} OV5646MIPI_SENSOR_MODE;

typedef enum _OV5646MIPI_OP_TYPE_ {
        OV5646MIPI_MODE_NONE,
        OV5646MIPI_MODE_PREVIEW,
        OV5646MIPI_MODE_CAPTURE,
        OV5646MIPI_MODE_QCIF_VIDEO,
        OV5646MIPI_MODE_CIF_VIDEO,
        OV5646MIPI_MODE_QVGA_VIDEO
    } OV5646MIPI_OP_TYPE;

extern OV5646MIPI_OP_TYPE OV5646MIPI_g_iOV5646MIPI_Mode;

#define OV5646MIPI_ID_REG                          (0x300A)
#define OV5646MIPI_INFO_REG                        (0x300B)
 
/* sensor size */
#define OV5646MIPI_IMAGE_SENSOR_SVGA_WIDTH          (1280)
#define OV5646MIPI_IMAGE_SENSOR_SVGA_HEIGHT         (960)
#define OV5646MIPI_IMAGE_SENSOR_QSXGA_WITDH         (2590)//(2592)
#define OV5646MIPI_IMAGE_SENSOR_QSXGA_HEIGHT        (1942)//(1944)
#define OV5646MIPI_IMAGE_SENSOR_VIDEO_WITDH         (1280) 
#define OV5646MIPI_IMAGE_SENSOR_VIDEO_HEIGHT        (960)

#define OV5646MIPI_IMAGE_SENSOR_720P_WIDTH          (1280)
#define OV5646MIPI_IMAGE_SENSOR_720P_HEIGHT         (720)


/* Sesnor Pixel/Line Numbers in One Period */	
#define OV5646MIPI_PV_PERIOD_PIXEL_NUMS    		(1896)  	/* Default preview line length HTS*/
#define OV5646MIPI_PV_PERIOD_LINE_NUMS     		(984)   	/* Default preview frame length  VTS*/
#define OV5646MIPI_FULL_PERIOD_PIXEL_NUMS  		(2844)  	/* Default full size line length */
#define OV5646MIPI_FULL_PERIOD_LINE_NUMS   		(1968)  	/* Default full size frame length */

/* Sensor Exposure Line Limitation */
#define OV5646MIPI_PV_EXPOSURE_LIMITATION      	(984-4)
#define OV5646MIPI_FULL_EXPOSURE_LIMITATION    	(1968-4)

/* Config the ISP grab start x & start y, Config the ISP grab width & height */
#define OV5646MIPI_PV_GRAB_START_X 				   (0)
#define OV5646MIPI_PV_GRAB_START_Y  			(1)
#define OV5646MIPI_FULL_GRAB_START_X   			(0)
#define OV5646MIPI_FULL_GRAB_START_Y	  		(1)

/*50Hz,60Hz*/
#define OV5646MIPI_NUM_50HZ                        (50 * 2)
#define OV5646MIPI_NUM_60HZ                        (60 * 2)

/* FRAME RATE UNIT */
#define OV5646MIPI_FRAME_RATE_UNIT                 (10)

/* MAX CAMERA FRAME RATE */
#define OV5646MIPI_MAX_CAMERA_FPS                  (OV5646MIPI_FRAME_RATE_UNIT * 30)

#define OV5646_PREVIEW_MODE             0
#define OV5646_VIDEO_MODE               1
#define OV5646_PREVIEW_FULLSIZE_MODE    2


/* SENSOR READ/WRITE ID */
#define OV5646MIPI_WRITE_ID						    0x78
#define OV5646MIPI_READ_ID							0x79
...
UINT32 OV5646MIPI_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT pfFunc);

int OV5646MIPI_firmware[]=
{
