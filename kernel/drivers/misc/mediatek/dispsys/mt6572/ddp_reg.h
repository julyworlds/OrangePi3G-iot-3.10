...
#define DISP_REG_SMI_LARB_FIFO_STAT0      (DDP_REG_BASE_SMI_LARB0 + 0x600)
#define DISP_REG_SMI_LARB_FIFO_STAT1      (DDP_REG_BASE_SMI_LARB0 + 0x604)
#define DISP_REG_SMI_LARB_BUS_STAT0       (DDP_REG_BASE_SMI_LARB0 + 0x610)
#define DISP_REG_SMI_LARB_BUS_STAT1       (DDP_REG_BASE_SMI_LARB0 + 0x614)

#define DISP_REG_SMI_DEBUG0               (DDP_REG_BASE_SMI_COMMON + 0x400)
