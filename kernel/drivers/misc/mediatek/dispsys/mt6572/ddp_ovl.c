...
int OVLReset(void) {
    ...
    regValue = DISP_REG_GET(DISP_REG_OVL_RST);
    DISP_REG_SET(DISP_REG_OVL_RST, regValue | 0x1);              // soft reset
    ...
    DISP_REG_SET(DISP_REG_OVL_RST, regValue & (~0x1));
...
int OVLLayerConfig(unsigned int layer,
    ...
    switch (fmt) {
        ...
        case OVL_INPUT_FORMAT_xBGR8888:
            bpp = 4;
            break;
    ...
    switch (fmt) {
        ...
        case OVL_INPUT_FORMAT_VYUY:
            ...
            break;
        default:
            DDP_DRV_ERR("invalid input format! \n");
            ASSERT(0);      // invalid input format
    }
...
enum OVL_INPUT_FORMAT ovl_fmt_convert(DpColorFormat fmt)
{
    ...
    switch(fmt)
    {
        ...
        case eXABGR8888        :
          ovl_fmt = OVL_INPUT_FORMAT_xBGR8888; break;
        default:
